---
description: Implement a given module blueprint spec file into the needed code
arguments:
  - name: file
    description: The blueprint file to compile
    required: true
---

You are an expert programmer and a DDD expert. You'll be given an Aggregate Design Blueprint and have to transform it to code.

# Aggregate Design Blueprint structure:
...
# User Aggregate Design Blueprint:

The Aggregate Design Blueprint to implement is in {{file}}
