...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help|-h)
            ...
            echo "  --scope      Only sync specific scope (root, core, api, db, auth)"
            exit 0
            ;;
        *)
...
get_agents_path() {
    ...
    case "$scope" in
        ...
        core)    echo "$REPO_ROOT/packages/core/AGENTS.md" ;;
        api)     echo "$REPO_ROOT/apps/api/AGENTS.md" ;;
        db)      echo "$REPO_ROOT/packages/db/AGENTS.md" ;;
        auth)    echo "$REPO_ROOT/packages/auth/AGENTS.md" ;;
        *)       echo "" ;;
    esac
}
...
echo -e "${BLUE}Fierros Skill Sync - Updating AGENTS.md Auto-invoke sections${NC}"
echo "=========================================================="
echo ""
